...
<script type="text/javascript" src="/style/authority/commonAll.js"></script>
<script type="text/javascript" src="/style/scripts/fancybox/jquery.fancybox-1.3.4.js"></script>
<script type="text/javascript" src="/style/scripts/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							名称:<input type="text" id="cName" name="cName" class="ui_input_txt01"  style="width:100px"/>

							电话号码:<input type="text" id="cPhone" name="cPhone" class="ui_input_txt02" />
							<!--栋号
				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<tr>
							...
							<td></td>
							<td>
								<a href=""><strong>借款记录</strong></a>
								<a href=""><strong>还款记录</strong></a>
							</td>
						</tr>
							<!--<tr>
