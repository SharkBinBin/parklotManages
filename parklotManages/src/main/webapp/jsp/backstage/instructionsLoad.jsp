...
<head>
    ...
    <script type="text/javascript">
        ...
        /** 模糊查询来电用户  **/
            ...
            var lid = $("#lid").val();
            var mname = $("#mname").val();
            location="InstructionsLoad?lid="+lid+"&mname="+mname;
        }
...
// 				return;
        ...
        //弹出一个输入框，输入一段文字，可以提交  
    function prom() {  
        var name = prompt("请输入否决理由", ""); //将输入的内容赋给变量 name ，  
  		var id = $("#userID").val();
        //这里需要注意的是，prompt有两个参数，前面是提示的话，后面是当对话框出来后，在对话框里的默认值  
        if (name)//如果返回的有内容  
        {  
            location="InstructionsLoadup?userID="+id+"&ly="+name+"&loantype=2";
        }  
    ...
    function firm() {  
        ...
        var id = $("#userID").val();
        if (confirm("请再次确认是否审批")) {  
            alert("审批通过");  
            location="InstructionsLoadup?userID="+id+"&loantype=1";
        }  
        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        订单号:<input type="text" id="lid" name="lid" class="ui_input_txt01"  style="width:100px"/>
                        用户名:<input type="text" id="mname" name="mname" class="ui_input_txt01" style="width:100px">
                    </div>
                    <div id="box_bottom">
            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="hidden" id="userID" name="userID" value="${list.loanID}">
                            <a onclick="firm();return;"><strong>批示</strong></a>
                            <a onclick="prom();return;"><strong>否决</strong></a>
                        </td>
                    </tr>
</c:forEach>
