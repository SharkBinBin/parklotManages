...
<head>
    ...
    <script type="text/javascript">
        ...
        /** 模糊查询来电用户  **/
        function search(){
            var loanId = $("#huankuanId").val()
        	location = "HuanKuan.html?huankuanId=" + loanId;
        }
        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        订单号:<input type="text" id="huankuanId" name="huankuanId" value="${huankuanId }" class="ui_input_txt01"  style="width:100px"/>
                    </div>
                    <div id="box_bottom">
        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <c:forEach items="${huanList}" var="list">
                    <tr>
                        <td>${list.huankuanId }</td>
                        <td>${list.huankuanJe }</td>
                        <td>${list.huankuanShi }</td>
                        <td>
                        <c:choose>
                        	<c:when test="${list.refundTypeId == 0}">
                        		未还款
                        	</c:when>
                        	<c:when test="${list.refundTypeId == 1}">
                        		已还款
                        	</c:when>
                        </c:choose>
                        </td>
                        ...
                        <td>
                        <c:if test="${list.refundTypeId == 1 }">
                            <a href="<%=basePath%>/huan/delete.html?huankuanId=${list.huankuanId}"><strong>确认还款</strong></a>
                         </c:if>
                        </td>
                    </tr>
					</c:forEach>
            ...
            <div class="ui_tb_h30">
                ...
                <div class="ui_frt">
                    ...
                    <a href="<%=basePath%>/huan/HuanKuan.html?huankuanId=${huankuanId }&pageIndex=1"><input type="button" value="首页" class="ui_input_btn01"/></a>
                    <a href="<%=basePath%>/huan/HuanKuan.html?huankuanId=${huankuanId }&pageIndex=${currentPageNo - 1 }"><input type="button" value="上一页" class="ui_input_btn01" /></a>
                    </c:if>  
                    <c:if test="${currentPageNo < totalpageCount }">
                    <a href="<%=basePath%>/huan/HuanKuan.html?huankuanId=${huankuanId }&pageIndex=${currentPageNo + 1 }"><input type="button" value="下一页" class="ui_input_btn01"
                           onclick="jumpNormalPage(2);" /></a>
                    <a href="<%=basePath%>/huan/HuanKuan.html?huankuanId=${huankuanId }&pageIndex=${totalpageCount}"><input type="button" value="尾页" class="ui_input_btn01"
