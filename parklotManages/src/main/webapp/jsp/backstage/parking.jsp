...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
        	$("#parkingExcel").click(function exportExcle(){
            	window.location.href="parkingExcel";
           	})
...
//                      data: "para="+para,  此处data可以为 a=1&b=2类型的字符串 或 json数据。
        ...
        function search(){
            ...
            location="Record?type="+type+"&type2="+type2+"&type3="+type3+"&platenumber="+platenumber+"&membership="+membership;
        }
        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                    <input id="parkingExcel" type="button" value="导出Excel" class="ui_input_btn01" />
        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="1" cellpadding="1" width="100%" align="center" border="1">
                    ...
                    <c:forEach items="${listRecord}" var="ll" varStatus="status">
                   	 	<tr align="center">
                    	<td>${status.count}</td> 
                    	<td>${ll.cityName}</td>
                        <td>${ll.siteName}</td>
