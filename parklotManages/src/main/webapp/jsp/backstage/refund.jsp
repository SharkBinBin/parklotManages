        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tr>
                        <td width="90px">${list.huankuanId}</td>
                        <td>${list.huankuanName}</td>
                        <td>${list.huankuanJe}</td>
                        <td>${list.huankuanJie}</td>
                        <td>${list.huankuanJiez}</td>
                        <td>
                            <a href=""><strong>申请延期</strong></a>
                            <c:if test="${list.refundTypeId == 0}">
                            <a href="<%=basePath%>/user/updateHuan.html?huankuanId=${list.huankuanId}"><strong>还款</strong></a>
                            </c:if>
                        </td>
                    </tr>
                    </c:forEach>
