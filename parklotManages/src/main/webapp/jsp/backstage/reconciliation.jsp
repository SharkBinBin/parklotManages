...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
        	$("#reconciliationExcel").click(function exportExcle(){
            	window.location.href="reconciliationExcel";
           	})
...
//                      data: "para="+para,  此处data可以为 a=1&b=2类型的字符串 或 json数据。
        ...
        function search(){
            ...
            location="Reconciliation?type="+type+"&type2="+type2+"&type3="+type3+"&method="+method;
        }
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                       ...
                       收费类型:   <select name="method" id="method">
                    ...
                    <div id="box_bottom">
                    <input id="reconciliationExcel" type="button" value="导出Excel" class="ui_input_btn01" />
        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="1" cellpadding="1" width="100%" align="center" border="1">
                    ...
                    <c:forEach items="${listRecon}" var="ll" varStatus="status">
                   	 	<tr align="center">
                    	<td>${status.count}</td> 
                    	<td>${ll.cityName}</td>
                        <td>${ll.siteName}</td>
